...
export const EXPERIENCE: Job[] = [
  {
    ...
    bullets: [
      ...
      'Led the qz.com replatform solo, building GitHub coding agents that generated the React component library from a prototype, and shipping a geo-based gradual rollout that lifted reader engagement 35%.',
      'Deployed an autonomous AI agent that took over an internal revenue-analysis workflow, refreshing a live dashboard end to end, and used its provenance checks to overturn a $19,380-a-month claim as noise.',
      'Cut p95 latency 96% by consolidating every product onto one internal REST API, retiring a legacy DynamoDB store behind an adapter that preserved the consumer contract exactly.',
    ],
    tech: ['Python', 'TypeScript', 'Next.js', 'AWS Lambda', 'Step Functions', 'Memgraph', 'MCP'],
  },
  {
    role: 'Software Developer (Part-Time, Contract)',
    company: 'Dopa',
    org: '',
    location: 'Remote',
